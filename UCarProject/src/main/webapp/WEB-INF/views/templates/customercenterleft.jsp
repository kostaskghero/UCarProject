...
<h4><a href="${initParam.root }auth_customercenter_home_qna_boardList.do?sessionId=${sessionScope.loginInfo.memberId}"><img src="#" ><br>1:1문의내용</a></h4><br><br>
<h4><a href="${initParam.root }customercenter_review_list.do"><img src="#" ><br>이용후기</a></h4><br><br>
