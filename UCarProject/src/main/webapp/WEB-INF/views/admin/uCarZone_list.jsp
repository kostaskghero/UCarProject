						...
						<tbody>
							<c:forEach items="${requestScope.list }" var="vo">
								<tr>
									...
									<td><button type="button" class="btn btn-xs" name="updateBtn"
											value="${vo.uCarZoneName}">수정</button></td>
									<td><button type="button" class="btn btn-xs" name="deleteBtn"
											value="${vo.uCarZoneName}">삭제</button></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
