		...
		<div class="row">
			<div class="col-md-6">
				<fieldset>
					...
					<div class="col-lg-10">
						<label for="reserve" class="col-lg-10 control-label">
							왕복 / ${reservationInfo.rentalDate } ~ ${reservationInfo.returnDate }
						</label>
					</div>
					<br><br>
			...
			<div class="col-md-6">
				...
				<div class="col-lg-10 col-lg-offset-9">
					<button type="button" class="btn btn-primary" id ="reserveRegisterBtn">예약하기</button>
				</div>				
			</div>
