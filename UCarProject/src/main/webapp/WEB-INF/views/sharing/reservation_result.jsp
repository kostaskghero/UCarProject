		...
		<div class="row">
			<div class="col-md-6">
				<fieldset>
					...
					<div class="col-lg-8">
						<label for="ucarZone" class="col-lg-8 control-label">
					...
					<div class="col-lg-8">
						<label for="ucarSpace" class="col-lg-8 control-label">
			...
			<div class="col-md-6">
				<fieldset>
					...
					<div class="col-lg-8">
						<label for="fee" class="col-lg-8 control-label" id="rentalPrice">
							${reservationInfo.rentalPrice } 원
						</label>
					</div>
					<br><br><br>
					<label for="fee" class="col-lg-2 control-label">포인트</label>
					<div class="col-lg-8" id = "pointForm">
					...
					<div class="col-lg-8">
						<label for="payTotal" class="col-lg-8 control-label">
