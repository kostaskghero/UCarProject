    ...
    function html5Upload() {	
    	var tempFile,
    		sUploadURL;
    	sUploadURL= 'http://localhost:8888/ucar/auth_review_multiplePhotoUpload.do'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			///photoUpload
 			sUrl  : 'http://localhost:8888/ucar/auth_review_multiplePhotoUpload.do',	//샘플 URL입니다.
