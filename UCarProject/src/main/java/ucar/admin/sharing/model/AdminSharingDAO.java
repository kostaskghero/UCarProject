...
public interface AdminSharingDAO {
	...
	public List<ReservationVO> searchSharingBySatausAndMemberId(
			ReservationVO rvo);

	public List<ReservationVO> searchSharingBySatausAndCarNickName(
			ReservationVO rvo);

	public List<ReservationVO> searchSharingByCarNickNameAndMemberId(
			ReservationVO rvo);

	public List<ReservationVO> searchSharingByCarNickNameAndMemberIdAndStataus(
			ReservationVO rvo);
}
